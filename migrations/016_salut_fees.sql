-- Migration 016: SALUT fee columns on orders
-- SALUT members pay Rp 0 for ongkir/box/admin fees; non-SALUT pay Rp 300.000 + 100.000 + 25.000
-- Run in Supabase SQL Editor

ALTER TABLE orders
  ADD COLUMN IF NOT EXISTS box_fee       NUMERIC(12,2) NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS admin_fee     NUMERIC(12,2) NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS is_salut_order BOOLEAN      NOT NULL DEFAULT false;

-- shipping_cost already exists and was always 0; now repurposed as ongkir (300000 or 0)

-- Update checkout_order() RPC to accept and store the new fee columns
